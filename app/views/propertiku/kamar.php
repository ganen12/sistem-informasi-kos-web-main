...
<body>
    ...
    <div class="row">
      ...
      <nav class="col-md-2 sidebar d-flex flex-column p-3">
        <ul class="nav flex-column mb-auto">
          ...
          <li><a href="kamar.html" class="nav-link active"><i class="bi bi-door-closed me-2 menu-list"></i>Kamar</a></li>
  ...
  <div class="modal fade" id="tambahKamarModal" tabindex="-1">
    <div class="modal-dialog">
      <form id="formKamar" class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <select class="form-select" id="selectProperti"></select>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="statusKamar">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control rupiah" id="hargaPerBulan" required>
          </div>
        </div>
